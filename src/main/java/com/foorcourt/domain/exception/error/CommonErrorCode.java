...
public enum CommonErrorCode  implements ErrorCode{
    ...
    INVALID_STATUS_TRANSITION("ERR_STATUS_TRANSITION_INVALID", "Only orders in LISTO status can be delivered", HttpStatus.BAD_REQUEST.value(), ErrorCategory.VALIDATION),
    ORDER_ALREADY_DELIVERED("ERR_ORDER_ALREADY_DELIVERED", "Delivered orders cannot be modified.", HttpStatus.BAD_REQUEST.value(), ErrorCategory.VALIDATION),
    INVALID_SECURITY_PIN("ERR_INVALID_SECURITY_PIN", "Incorrect security PIN", HttpStatus.BAD_REQUEST.value(), ErrorCategory.VALIDATION),
    ...
    STATUS_DONT_BE_CANCELED("ERR_STATUS_DONT_BE_CANCELED", "Sorry, your order is already being prepared and cannot be cancelled.", HttpStatus.CONFLICT.value(),ErrorCategory.BUSINESS),
